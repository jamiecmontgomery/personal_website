...
```{r tweets_over_time, fig.width = 8, fig.height = 4}
...
This project was funded by Oceankind. All code is available at this [github repo](https://github.com/ohi-science/sb_sense_of_place). Twitter data is kept offline and secure at the National Center for Ecological Analysis & Synthesis.